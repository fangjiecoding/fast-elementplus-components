import { defineComponent as u, resolveComponent as s, openBlock as t, createBlock as c, mergeProps as z, withCtx as h, createElementBlock as l, Fragment as m, renderList as x, resolveDynamicComponent as g, createCommentVNode as i, createElementVNode as e, toDisplayString as f, createVNode as n, isVNode as H } from "vue";
const V = /* @__PURE__ */ u({
  __name: "index",
  props: {
    // 导航菜单的数据
  ...
  for (const [v, o] of r)
    _[v] = o;
  return _;
}, B = /* @__PURE__ */ y(V, [["__scopeId", "data-v-f522c135"]]);
...
const x_ = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ChromeFilled: h0,
  CircleCheck: w0,
  CircleCheckFilled: m0,
  CircleClose: z0,
  CircleCloseFilled: f0,
  CirclePlus: V0,
  CirclePlusFilled: C0,
  Clock: B0,
  Close: b0,
  ...
  Van: Wt,
  VideoCamera: Kt,
  VideoCameraFilled: Nt,
  VideoPause: Qt,
  VideoPlay: Jt,
  View: Yt,
  Wallet: __,
  WalletFilled: a_,
  WarnTriangleFilled: l_,
  Warning: v_,
  WarningFilled: o_,
  Watch: c_,
  Watermelon: h_,
...
const M_ = {
  ...
  install(a) {
    a.component("m-menu", B), a.component("m-infinite-menu", M_);
  }
};
export {
  H_ as default
