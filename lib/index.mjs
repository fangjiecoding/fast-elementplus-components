...
const M = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
        ...
        default: h(() => [
          (_(!0), l(
            ...
            x(a.data, (p, C) => (_(), l(
              ...
              { key: C },
              [
                !p[a.children] || !p[a.children].length ? (_(), c(v, {
                  key: 0,
                  index: p[a.index]
                }, {
                  default: h(() => [
                    p[a.icon] ? (_(), c(g(`${p[a.icon]}`), { key: 0 })) : i("v-if", !0),
                    e(
                      "span",
                      null,
                      f(p[a.name]),
                ...
                p[a.children] && p[a.children].length ? (_(), c(o, {
                  key: 1,
                  index: p[a.index]
                }, {
                  title: h(() => [
                    p[a.icon] ? (_(), c(g(`${p[a.icon]}`), {
                      key: 0,
                      '"': ""
                    })) : i("v-if", !0),
                    e(
                  ...
                  default: h(() => [
                    (_(!0), l(
                      m,
                      null,
                      x(p[a.children], (w, H) => (_(), c(v, {
                        key: H,
                        index: w.index
                      }, {
                        default: h(() => [
                          w[a.icon] ? (_(), c(g(`${p[a.icon]}`), { key: 0 })) : i("v-if", !0),
                          e(
                            "span",
                            null,
                            f(w[a.name]),
  ...
  for (const [v, o] of t)
    r[v] = o;
  return r;
}, x_ = /* @__PURE__ */ f_(g_, [["__scopeId", "data-v-650d1810"]]);
function z_(a) {
