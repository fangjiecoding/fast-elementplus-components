import { defineComponent as u, openBlock as t, createElementBlock as l, createElementVNode as e, resolveComponent as s, createBlock as c, mergeProps as z, withCtx as h, Fragment as m, renderList as x, resolveDynamicComponent as g, createCommentVNode as i, toDisplayString as f, createVNode as n, isVNode as V } from "vue";
...
const M = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ChromeFilled: c0,
  CircleCheck: m0,
  CircleCheckFilled: h0,
  CircleClose: f0,
  CircleCloseFilled: w0,
  CirclePlus: C0,
  CirclePlusFilled: z0,
  Clock: V0,
  Close: A0,
  ...
  Van: It,
  VideoCamera: Nt,
  VideoCameraFilled: Wt,
  VideoPause: jt,
  VideoPlay: $t,
  View: Jt,
  Wallet: a_,
  WalletFilled: Yt,
  WarnTriangleFilled: __,
  Warning: o_,
  WarningFilled: l_,
  Watch: v_,
  Watermelon: c_,
  ...
  ZoomIn: m_,
  ZoomOut: w_
}, Symbol.toStringTag, { value: "Module" })), g_ = /* @__PURE__ */ u({
  __name: "index",
  props: {
    // 导航菜单的数据
    data: {
  ...
  setup(a) {
    return (_, r) => {
      const v = s("el-menu-item"), o = s("el-sub-menu"), d = s("el-menu");
      return t(), c(d, z({
        ...
        default: h(() => [
          (t(!0), l(
            ...
            x(a.data, (p, C) => (t(), l(
              ...
              { key: C },
              [
                !p[a.children] || !p[a.children].length ? (t(), c(v, {
                  key: 0,
                  index: p[a.index]
                }, {
                  default: h(() => [
                    p[a.icon] ? (t(), c(g(`${p[a.icon]}`), { key: 0 })) : i("v-if", !0),
                    e(
                      "span",
                      null,
                      f(p[a.name]),
                ...
                p[a.children] && p[a.children].length ? (t(), c(o, {
                  key: 1,
                  index: p[a.index]
                }, {
                  title: h(() => [
                  ...
                  default: h(() => [
                    (t(!0), l(
                      m,
                      null,
                      x(p[a.children], (w, H) => (t(), c(v, {
                        key: H,
                        index: w.index
                      }, {
                        default: h(() => [
                          w[a.icon] ? (t(), c(g(`${p[a.icon]}`), { key: 0 })) : i("v-if", !0),
                          e(
                            "span",
                            null,
                            f(w[a.name]),
  ...
  for (const [v, o] of _)
    r[v] = o;
  return r;
}, x_ = /* @__PURE__ */ f_(g_, [["__scopeId", "data-v-f522c135"]]);
function z_(a) {
  return typeof a == "function" || Object.prototype.toString.call(a) === "[object Object]" && !V(a);
}
const M_ = {
  props: {
    // 导航菜单的数据
  ...
  setup(a, _) {
    const r = (v) => v.map((o) => {
      o.i = M[o[a.icon]];
      const d = {
        title: () => n(m, null, [n(o.i, null, null), n("span", null, [o[a.name]])])
      };
      return o[a.children] && o[a.children].length ? n(s("el-sub-menu"), {
        index: o[a.index]
      }, {
        default: () => [r(o[a.children])],
        ...d
      }) : n(s("el-menu-item"), {
        index: o[a.index]
      }, {
    ...
    return () => {
      let v;
      return n(s("el-menu"), z({
        class: "menu-icon-svg",
        "default-active": a.defaultActive,
        router: a.router
      }, _.attrs), z_(v = r(a.data)) ? v : {
        default: () => [v]
      });
    };
  }
  ...
  install(a) {
    a.component("m-menu", x_), a.component("m-infinite-menu", M_);
  }
}, H_ = [C_], y_ = {
  install(a) {
    H_.map((_) => {
    ...
    for (const [_, r] of Object.entries(M))
      a.component(_, r);
  }
};
export {
