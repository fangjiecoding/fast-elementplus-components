                  ...
                  x(
                    ...
                    (p, M) => (
                      ...
                      l(
                        ...
                        { key: M },
                        [
                          !p[a.children] || !p[a.children].length
                            ? (t(),
                              c(
                                v,
                                {
...
var L = /* @__PURE__ */ u({
  ...
  f_ = g_
const x_ = /* @__PURE__ */ Object.freeze(
...
function z_(a) {
  return (
    typeof a == 'function' || (Object.prototype.toString.call(a) === '[object Object]' && !H(a))
  )
}
const M_ = /* @__PURE__ */ u({
    props: {
    ...
    setup(a) {
      const _ = (v) =>
          v.map((o) => {
            ...
            return o[a.children] && o[a.children].length
              ? n(
                  s('el-sub-menu'),
                  {
                    index: o[a.index]
